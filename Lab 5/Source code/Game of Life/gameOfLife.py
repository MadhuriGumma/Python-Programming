...
class GameOfLife:
    def __init__(self, N=10, T=20):

        # Created 2 grids old and New
        ...
        # Initial Configuration for the grid
    ...
    def living_neighbours(self, i, j):
        # Count the no. of ive neighbours around a point (i,j)
    ...
    def play(self):
        ...
        output_frequency = 5  # How frequently we want to output a grid configuration.
        while t <= self.T:  # Evolve!
            ...
            for i in range(self.N):
                for j in range(self.N):
                    live = self.living_neighbours(i, j)
